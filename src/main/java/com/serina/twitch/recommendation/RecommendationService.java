...
import com.serina.twitch.external.TwitchService;
...
import com.serina.twitch.favorite.FavoriteService;
...
public class RecommendationService {
    ...
    @Cacheable(value = "recommend_items")
    public TypeGroupedItemList recommendItems(UserEntity userEntity) throws IOException {
        List<String> gameIds;
